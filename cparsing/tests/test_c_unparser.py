...
def is_c_to_c_correct(src: str, *, reduce_parentheses: bool = False):
    ...
    return c_ast.compare_asts(parse(src), parse(reparsed_src))
...
def test_c_to_c(test_input: str):
    assert is_c_to_c_correct(test_input)
...
def test_minimum_parentheses_binaryops(test_input: str):
    ...
    assert is_c_to_c_correct(test_input, reduce_parentheses=True)
